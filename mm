...
class TopBooks(models.Model):
    book = models.CharField(db_column='Book', max_length=100)  # Field name made lowercase.
    top1 = models.CharField(db_column='Top1', max_length=100)  # Field name made lowercase.
    top2 = models.CharField(db_column='Top2', max_length=100)  # Field name made lowercase.
    top3 = models.CharField(db_column='Top3', max_length=100)  # Field name made lowercase.
